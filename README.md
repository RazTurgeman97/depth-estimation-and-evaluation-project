...
<div style="display: flex; justify-content: space-between;">
  <div style="width: 48%; text-align: center;">
    <img src="documents/media/depth_comparison_frame_97.png" alt="Depth Comparison Frame 97">
    <img src="documents/media/indoor_gif.gif" alt="Indoor Visual Comparison">
    <p><strong>Figure 1:</strong> Indoor Visual Comparison</p>
  </div>
  <div style="width: 48%; text-align: center;">
    <img src="documents/media/depth_comparison_frame_35.png" alt="Depth Comparison Frame 35">
